...
Чтобы освоить `git` требуется знать командную строку. Если такие команды как `touch`, `ls`, `rm`, `cd` вызывают в вас чувство недоумения и ужас, то стоит попробовать свои силы в командной оболочке, тут может помочь статья на [хабре](https://habr.com/ru/articles/501442/)

`git` - это консольная команда, работает без графического интерфейса. И чтобы научиться ей пользоваться, вам надо уметь запускать саму консоль и в ней ориентироваться, иначе все дальнейшее бесполезно.
...
Хорошее сообщение содержит информацию о том _что и где_ было изменено. Можно также добавлять номер задачи.

Плохое сообщение "Добавил забытые комманды. Как много я знаю оказывается!"

Есть несколько разных соглашений о том, как писать коммиты. С одним можно ознакомиться на [официальном сайте](https://www.conventionalcommits.org/ru/v1.0.0/).

Или использовать простые правила:

+ длина сообщения от 3030 до 7272 символов;
+ первое слово — глагол в инфинитиве («исправить», «дополнить», «добавить» и другие);
+ использовать идентификатор из нескольких заглавных латинских букв и номера: `LGS-239` значит, что это 239-я задача в проекте LGS (сокращение от англ. logistics — «логистика»).
+ ...

Какой пользоваться решайте сами или вам подскажут в вашей команде. 

# Автор

Гайд был написан [Дмитрием Фроленко](https://github.com/thefrol), августовскими вечерами 2023 г на диване